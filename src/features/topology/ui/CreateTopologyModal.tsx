...
export function CreateTopologyModal({ existingNames, onClose, onConfirm, saving, error }: CreateTopologyModalProps): React.JSX.Element {
  ...
  const handleConfirm = useCallback((): void => {
    if (isEmpty || duplicate || saving) return;
    onConfirm(trimmed);
  }, [isEmpty, duplicate, saving, trimmed, onConfirm]);
    ...
    <div ref={backdropRef} onClick={handleBackdropClick} className={styles.backdrop}>
      <div className={styles.modal}>
        ...
        <div className={styles.header}>
          <h2 className={styles.headerTitle}>New Topology</h2>
        ...
        <div className={styles.body}>
          <div className={styles.field}>
            <label className={styles.fieldLabel}>Topology name</label>
            <input
              ref={inputRef}
              type="text"
              value={name}
        ...
        <div className={styles.footer}>
          ...
          <button
            ...
            disabled={saving || isEmpty || duplicate}
